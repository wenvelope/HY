...
gradlePlugin {
    plugins {
        register("kmpLibraryComposePlugin") {
            id =
                libs.plugins.kmp.library.compose.feature.plugin
                    .get()
                    .pluginId
        ...
        register("kmpLibrarySerializationPlugin") {
            id =
                libs.plugins.kmp.library.serialization.feature.plugin
                    .get()
                    .pluginId
        ...
        register("kmpLibraryKoinPlugin") {
            id =
                libs.plugins.kmp.library.koin.feature.plugin
                    .get()
                    .pluginId
        ...
        register("kmpLibraryUdfPlugin") {
            id =
                libs.plugins.kmp.library.udf.feature.plugin
                    .get()
                    .pluginId
        ...
        register("kmpLibraryRoomPlugin") {
            id =
                libs.plugins.kmp.library.room.feature.plugin
                    .get()
                    .pluginId
        ...
        register("kmpApplicationComposePlugin") {
            id =
                libs.plugins.kmp.application.compose.feature.plugin
                    .get()
                    .pluginId
        ...
        register("kmpApplicationKoinPlugin") {
            id =
                libs.plugins.kmp.application.koin.feature.plugin
                    .get()
                    .pluginId
